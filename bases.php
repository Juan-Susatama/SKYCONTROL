                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar una base</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="search">
                                        <input placeholder="Digite el nombre de la base" type="text" name="input_nombre_base">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_base') {
                                            ...
                                            if (!empty($input_nombre_base)){
                                                $sql = "SELECT * FROM base WHERE nombre = '$input_nombre_base'";
                                                $result = mysqli_query($link, $sql);
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear base</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='bases_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar base</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='bases_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar base</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='bases_form_delete.php'">
