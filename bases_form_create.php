            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulario para crear bases</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Registra y gestiona las bases de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input placeholder="Digite a ubcación de la base" type="text" name ="input_destino_base">
                                            </div>
                                        </div>
                                        <div class="centrar">
                                    ...
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            ...
                                            if (!empty($input_nombre_base) && !empty($input_destino_base)) {
                                                ...
                                                $sql = "SELECT nombre FROM base WHERE nombre = '$input_nombre_base'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) >= 1) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El nombre ya esta asignado a una base. Por favor, ingrese otro.');
                                                        window.location.href='bases_form_create.php';
                                                    </script>";
                                                    exit();
                                                } 

                                                $sql = "INSERT INTO base (nombre, destino) 
                                                        VALUES ('$input_nombre_base', '$input_destino_base')";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite todos los campos para añadir una base.');
                                                        window.location.href='bases_form_create.php';
                                                    </script>";
                                                exit();
                                            }
