                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un usuario</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_usuario') {
                                            ...
                                            if (!empty($input_cedula_usuario)){
                                                $sql = "SELECT * FROM persona WHERE cedula = '$input_cedula_usuario'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula no esta asignada a un usuario. Por favor, ingrese otra.');
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear usuario</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='usuarios_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar usuario</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='usuarios_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar usuario</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='usuarios_form_delete.php'">
