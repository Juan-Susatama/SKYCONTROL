                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un mantenimiento</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="buscar_avion">
                                    <div class="search">
                                        <h5 class="txt_crud">Digite la fecha de revision</h5><br>
                                        <input placeholder="Digite la fecha de revision" type="date" name="input_fecha_mantenimiento"><br><br>
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_avion') {
                                            ...
                                            if (!empty($input_codigo_avion_mantenimiento) && !empty($input_fecha_mantenimiento)){

                                                $sql = "SELECT * FROM mantenimiento WHERE codigoavion = $input_codigo_avion_mantenimiento AND fecha_revision = '$input_fecha_mantenimiento'";
                                                $result = mysqli_query($link, $sql);
                                                ...
                                                if (mysqli_num_rows($result) == 0) { 
                                                    ...
                                                    echo '<div class="search" style="padding-top: 30px;">
                                                        <div style="margin-bottom: 20px;">
                                                            ...
                                                            <input type="text" value="' . htmlspecialchars($codigo_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Base</h5>
                                                        <input type="text" value="' . htmlspecialchars($nombre_base_encontrada) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Fecha de revision</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear mantenimiento</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='mantenimiento_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar mantenimiento</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='mantenimiento_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar mantenimiento</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='mantenimiento_form_delete.php'">
