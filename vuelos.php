                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un vuelo</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear vuelo</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='vuelos_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar vuelo</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='vuelos_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar vuelo</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='vuelos_form_delete.php'">
