            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulario para modificar bases</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Modifica y gestiona las bases de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="buscar_bases">
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite el nombre de la base a modificar" type="text" name="modificar_nombre_base">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_bases') {
                                            $modificar_nombre_base = isset($_POST['modificar_nombre_base']) ? $_POST['modificar_nombre_base'] : null;

                                            if (!empty($modificar_nombre_base)){
                                                $sql = "SELECT * FROM base WHERE nombre = '$modificar_nombre_base'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El nombre de la base no existe. Por favor, ingrese otro.');
                                                        window.location.href='bases_form_update.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="actualizar_base">
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                name="input_nombre_base">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Destino</h5>
                                                <input placeholder="Digite el nombre del piloto" type="text" value="<?php echo htmlspecialchars($destino_encontrado); ?>" 
                                                name="input_destino_base">
                                            </div>
                                        </div>
                                        <div class="centrar">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'actualizar_base') {
                                            $input_nombre_base = isset($_POST['input_nombre_base']) ? $_POST['input_nombre_base'] : null;
                                            $input_destino_base = isset($_POST['input_destino_base']) ? $_POST['input_destino_base'] : null;

                                            if (!empty($input_nombre_base) && !empty($input_destino_base)) {

                                                $sql = "UPDATE base SET destino = '$input_destino_base' WHERE nombre = '$input_nombre_base'";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite todos los campos para actualizar una base.');
                                                        window.location.href='bases_form_update.php';
                                                    </script>";
                                                exit();
                                            }
