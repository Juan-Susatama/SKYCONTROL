...
<head>
    ...
    <title>SkyControl - Aviones</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulario para modificar aviones</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Modifica y gestiona la flota de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite el código del avión a modificar" type="number" name="modificar_codigo_avion">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_avion') {
                                            $modificar_codigo_avion = isset($_POST['modificar_codigo_avion']) ? $_POST['modificar_codigo_avion'] : null;

                                            if (!empty($modificar_codigo_avion)){
                                                $sql = "SELECT * FROM avion WHERE codigo = '$modificar_codigo_avion'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El codigo de avión no existe. Por favor, ingrese otro.');
                                                        window.location.href='aviones_form_update.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                                    $codigo_encontrado = $row['codigo'];
                                                    $tipo_encontrado = $row['tipo'];
                                                } 
                                            }
                                        }
                                    ?>
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="actualizar_avion">
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Código avión</h5>
                                                <input type="number" value="<?php echo htmlspecialchars($codigo_encontrado); ?>" readonly
                                                name="input_codigo_avion">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Tipo avión</h5>
                                                <input placeholder="Digite el tipo del avión" type="text" value="<?php echo htmlspecialchars($tipo_encontrado); ?>" 
                                                name="input_tipo_avion">
                                            </div>
                                        </div>
                                        <div class="centrar">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'actualizar_avion') {
                                            $input_codigo_avion = isset($_POST['input_codigo_avion']) ? $_POST['input_codigo_avion'] : null;
                                            $input_tipo_avion = isset($_POST['input_tipo_avion']) ? $_POST['input_tipo_avion'] : null;
                                            if (!empty($input_codigo_avion) && !empty($input_tipo_avion)) {
                                                $sql = "UPDATE avion SET tipo = '$input_tipo_avion' WHERE codigo = '$input_codigo_avion'";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite todos los campos para actualizar un avión.');
                                                        window.location.href='aviones_form_update.php';
                                                    </script>";
                                                exit();
                                            }
