            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Elimina usuarios</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Elimina y gestiona los usuarios de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="buscar_usuario">
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite la cedula del usuario a eliminar" type="number" name="input_eliminar_usuario">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_usuario') {
                                            $input_eliminar_usuario = isset($_POST['input_eliminar_usuario']) ? $_POST['input_eliminar_usuario'] : null;

                                            if (!empty($input_eliminar_usuario)){
                                                $sql = "SELECT * FROM persona WHERE cedula = '$input_eliminar_usuario'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula del usuario no existe. Por favor, ingrese otra.');
                                                        window.location.href='usuarios_form_delete.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="mostrar_usuario">
                                    <div style="padding: 20px;">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input type="text" value="<?php echo htmlspecialchars($nombre_encontrado); ?>" readonly
                                                name="input_nombre_usuario">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Apellido</h5>
                                                <input type="text" value="<?php echo htmlspecialchars($apellido_encontrado); ?>" readonly
                                                name="input_apellido_usuario">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Correo eléctronico</h5>
                                                <input type="email" value="<?php echo htmlspecialchars($correo_encontrado); ?>" readonly
                                                name="input_correo_usuario">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Contraseña</h5>
                                                <input type="password" value="<?php echo htmlspecialchars($contraseña_encontrada); ?>" readonly
                                                name="input_password_usuario">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Rol</h5>
                                                <input type="text" value="<?php echo htmlspecialchars($rol_encontrado); ?>" readonly
                                                name="input_rol_usuario">
                                            </div>
                                        </div>
                                        <div class="centrar">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'mostrar_usuario') {
                                            $input_cedula_usuario = isset($_POST['input_cedula_usuario']) ? $_POST['input_cedula_usuario'] : null;

                                            if (!empty($input_cedula_usuario)) {

                                                $sql = "SELECT cedula FROM piloto WHERE cedula = '$input_cedula_usuario'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) >= 1) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El usuario tiene el rol de piloto asignado, primero debes eliminarlo como piloto.');
                                                        window.location.href='usuarios_form_delete.php';
                                                    </script>";
                                                    exit();
                                                }

                                                $sql = "SELECT cedula FROM miembro_tripulacion WHERE cedula = '$input_cedula_usuario'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) >= 1) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El usuario tiene el rol de miembro de tripulación asignado, primero debes eliminarlo como miembro de tripulación.');
                                                        window.location.href='usuarios_form_delete.php';
                                                    </script>";
                                                    exit();
                                                }
                                                ...
                                                $sql = "DELETE FROM persona WHERE cedula = '$input_cedula_usuario'";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite el usuario a eliminar.');
                                                        window.location.href='usuarios_form_delete.php';
                                                    </script>";
                                                exit();
                                            }
