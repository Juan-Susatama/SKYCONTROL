...
<head>
    ...
    <title>SkyControl - Informes</title>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Modulo generación de reportes</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form action='generar_informe.php' method="post" target="_blank">
                                    <input type="hidden" name="formulario" value="buscar_vuelo">
                                    <div class="txt_crud" style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px;">
                                        <label for="menu">Seleccione el tipo de reporte:</label>
                                        <select name="tiempo_reporte" id="menu" style="margin-left: 20px;">
                                            <option value="semanal">Semanal</option>
                                            <option value="mensual">Mensual</option>
                                        </select>                                           
                                    </div>
                                    <div class="txt_crud" style="display: flex; align-items: center; justify-content: center; margin-bottom: 10px;">
                                        <label for="menu">Seleccione el tipo de usuario:</label>
                                        <select name="usuario_reporte" id="menu" style="margin-left: 20px;">
                                            <option value="piloto">Piloto</option>
                                            <option value="miembro">Miembro de tripulación</option>
