            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Miembros de tripulación</h1>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un miembro de tripulación</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="search">
                                        <input placeholder="Digite el codigo del miembro de tripulación" type="number" name="input_cedula_miembro">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_miembro') {
                                            ...
                                            if (!empty($input_cedula_miembro)){
                                                $sql = "SELECT * FROM miembro_tripulacion WHERE cedula = '$input_cedula_miembro'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula no esta asignada a un miembro de tripulación. Por favor, ingrese otra.');
                                                    ...
                                                    $sql = "SELECT * FROM persona WHERE cedula = '$input_cedula_miembro'";
                                                    $result = mysqli_query($link, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    ...
                                                    $rol_encontrado = $row['rol'];

                                                    $sql = "SELECT * FROM regreso WHERE cedula = '$input_cedula_miembro'";
                                                    $result = mysqli_query($link, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    $nombre_base_encontrado = $row['nombre_base'];

                                                    $sql = "SELECT * FROM base WHERE nombre = '$nombre_base_encontrado'";
                                                    $result = mysqli_query($link, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    $destino_base_encontrado = $row['destino'];

                                                    echo '<div class="search" style="padding-top: 30px;">
                                                        <div style="margin-bottom: 20px;">
                                                            <h5 class="txt_crud" style="margin-bottom: 5px;">Cedula</h5>
                                                            <input type="text" value="' . htmlspecialchars($cedula_encontrada) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Nombre</h5>
                                                        <input type="text" value="' . htmlspecialchars($nombre_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Apellido</h5>
                                                        <input type="text" value="' . htmlspecialchars($apellido_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Correo</h5>
                                                        <input type="text" value="' . htmlspecialchars($correo_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Rol</h5>
                                                        <input type="text" value="' . htmlspecialchars($rol_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Base</h5>
                                                        <input type="text" value="' . htmlspecialchars($nombre_base_encontrado) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Destino base</h5>
                                                        <input type="text" value="' . htmlspecialchars($destino_base_encontrado) . '" readonly>
                                                        </div>
                                                        </div>';
                                                } 
                                            }
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear miembro <br> de tripulación</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='mtripulacion_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar miembro <br> de tripulación</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='mtripulacion_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar miembro <br> de tripulación</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='mtripulacion_form_delete.php'">
