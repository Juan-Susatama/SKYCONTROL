            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Elimina miembros de tripulación</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Elimina y gestiona los miembros de tripulación en tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite la cedula del miembro de tripulación a eliminar" type="number" name="input_eliminar_miembro">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_miembro') {
                                            $input_eliminar_miembro = isset($_POST['input_eliminar_miembro']) ? $_POST['input_eliminar_miembro'] : null;

                                            if (!empty($input_eliminar_miembro)){
                                                $sql = "SELECT * FROM miembro_tripulacion WHERE cedula = '$input_eliminar_miembro'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula del miembro de tripulación no existe. Por favor, ingrese otra.');
                                                        window.location.href='mtripulacion_form_delete.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="mostrar_miembro">
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                name="cedula_miembro_dato" readonly>
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'mostrar_miembro') {
                                            $cedula_miembro_dato = isset($_POST['cedula_miembro_dato']) ? $_POST['cedula_miembro_dato'] : null;

                                            if (!empty($cedula_miembro_dato)) {
                                                $sql = "DELETE FROM miembro_tripulacion WHERE cedula = '$cedula_miembro_dato'";
                                                $sql2 = "DELETE FROM regreso WHERE cedula = '$cedula_miembro_dato'";
                                                $sql3 = "UPDATE persona SET rol = 'usuario' WHERE cedula = '$cedula_miembro_dato'";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite el miembro de tripulacion a eliminar.');
                                                        window.location.href='mtripulacion_form_delete.php';
                                                    </script>";
                                                exit();
                                            }
