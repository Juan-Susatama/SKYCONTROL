                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite el código del avión a eliminar" type="number" name="input_eliminar_avion">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_avion') {
                                            $input_eliminar_avion = isset($_POST['input_eliminar_avion']) ? $_POST['input_eliminar_avion'] : null;

                                            if (!empty($input_eliminar_avion)){
                                                $sql = "SELECT * FROM avion WHERE codigo = '$input_eliminar_avion'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El codigo de avión no existe. Por favor, ingrese otro.');
                                                        window.location.href='aviones_form_delete.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <form method="POST">
                                    <input type="hidden" name="formulario" value="mostrar_avion">
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Código avión</h5>
                                                <input type="text" value="<?php echo htmlspecialchars($codigo_encontrado); ?>"
                                                name="codigo_avion_dato" readonly>
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Tipo avión</h5>
                                                <input type="text" value="<?php echo htmlspecialchars($tipo_encontrado); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="centrar">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'mostrar_avion') {
                                            $codigo_avion_dato = isset($_POST['codigo_avion_dato']) ? $_POST['codigo_avion_dato'] : null;

                                            if (!empty($codigo_avion_dato)) {
                                                $sql = "DELETE FROM avion WHERE codigo = '$codigo_avion_dato'";
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite el avión a eliminar.');
                                                        window.location.href='aviones_form_delete.php';
                                                    </script>";
                                                exit();
                                            }
