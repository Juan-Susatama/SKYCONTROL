            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulario para modificar usuarios</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Modifica y gestiona los usuarios de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="centrar">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                <input placeholder="Digite la cedula del usuario a modificar" type="number" name="modificar_cedula_usuario">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_usuario') {
                                            $modificar_cedula_usuario = isset($_POST['modificar_cedula_usuario']) ? $_POST['modificar_cedula_usuario'] : null;

                                            if (!empty($modificar_cedula_usuario)){
                                                $sql = "SELECT * FROM persona WHERE cedula = '$modificar_cedula_usuario'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula del usuario no existe. Por favor, ingrese otra.');
                                                        window.location.href='usuarios_form_update.php';
                                                    </script>";
                                                    exit();
                                                }else{
                                                    $row = mysqli_fetch_assoc($result);
                                    ...
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input placeholder="Digite el rol del usuario" type="text" value="<?php echo htmlspecialchars($rol_encontrado); ?>" 
                                    ...
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'actualizar_usuario') {
                                            ...
                                            if (!empty($input_cedula_usuario) && !empty($input_nombre_usuario) && !empty($input_apellido_usuario) && !empty($input_correo_usuario) 
                                              && !empty($input_password_usuario) && !empty($input_confirmar_password_usuario) && !empty($input_rol_usuario)) {
                                                ...
                                                $sql = "UPDATE persona SET nombre = '$input_nombre_usuario', apellido = '$input_apellido_usuario', correo = '$input_correo_usuario',
                                                        contrasenia = '$input_password_usuario', rol = '$input_rol_usuario' WHERE cedula = '$input_cedula_usuario'";
