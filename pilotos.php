                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un piloto</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_piloto') {
                                            ...
                                            if (!empty($input_cedula_piloto)){
                                                $sql = "SELECT * FROM piloto WHERE cedula = '$input_cedula_piloto'";
                                                $result = mysqli_query($link, $sql);

                                                if (mysqli_num_rows($result) == 0) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('La cedula no esta asignada a un piloto. Por favor, ingrese otra.');
                                                    ...
                                                    $sql = "SELECT * FROM persona WHERE cedula = '$input_cedula_piloto'";
                                                    $result = mysqli_query($link, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    ...
                                                    $sql = "SELECT * FROM regreso WHERE cedula = '$input_cedula_piloto'";
                                                    $result = mysqli_query($link, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    ...
                                                    echo '<div class="search" style="padding-top: 30px;">
                                                        ...
                                                        <input type="text" value="' . htmlspecialchars($hvuelo_encontrada) . '" readonly>
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear piloto</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='pilotos_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar piloto</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='pilotos_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar piloto</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='pilotos_form_delete.php'">
