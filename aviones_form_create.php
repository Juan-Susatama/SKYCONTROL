            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulario para crear aviones</h1>
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Registra y gestiona la flota de tu aerolínea</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div style="padding: 20px;">
                                        <div class="search">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input placeholder="Digite el código del avión" type="number" name ="input_codigo_avion">
                                            </div>
                                            <div style="margin-bottom: 20px;">
                                                <h5 class="txt_crud" style="margin-bottom: 5px;">Tipo avión</h5>
                                                <input placeholder="Digite el tipo del avión" type="text" name ="input_tipo_avion">
                                            </div>
                                        </div>
                                        <div class="centrar">
                                            ...
                                            if (!empty($input_codigo_avion) && !empty($input_tipo_avion)) {
                                                ...
                                                if (mysqli_num_rows($result) >= 1) { 
                                                    echo "<script type='text/javascript'>
                                                        alert('El codigo de avión ya existe. Por favor, ingrese otro.');
                                                        window.location.href='aviones_form_create.php';
                                                    </script>";
                                                    exit();
                                                } 

                                                $sql = "INSERT INTO avion (codigo, tipo) 
                                                        VALUES ($input_codigo_avion, '$input_tipo_avion')"; 
                                                ...
                                                echo "<script type='text/javascript'>
                                                        alert('Por favor digite todos los campos para generar un avión.');
                                                        window.location.href='aviones_form_create.php';
                                                    </script>";
                                                exit();
                                            }
