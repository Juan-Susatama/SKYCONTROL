            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Aviones</h1>
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Consultar un avión</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="search">
                                        <input placeholder="Digite el codigo del avión" type="text" name="input_codigo_avion">
                                ...
                                <div>
                                    <?php
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['formulario'] === 'buscar_avion') {
                                            ...
                                            if (!empty($input_codigo_avion)){
                                                $sql = "SELECT * FROM avion WHERE codigo = '$input_codigo_avion'";
                                                $result = mysqli_query($link, $sql);
                                                ...
                                                if (mysqli_num_rows($result) == 0) { 
                                                    ...
                                                    echo '<div class="search" style="padding-top: 30px;">
                                                        <div style="margin-bottom: 20px;">
                                                            ...
                                                            <input placeholder="Digite el código del avión" type="text" value="' . htmlspecialchars($codigo_encontrado) . '" readonly name="input_codigo_avion">
                                                        </div>
                                                        <div style="margin-bottom: 20px;">
                                                        <h5 class="txt_crud" style="margin-bottom: 5px;">Tipo avión</h5>
                                                        <input placeholder="Digite el tipo del avión" type="text" value="' . htmlspecialchars($tipo_encontrado) . '" readonly name="input_tipo_avion">
                                                        </div>
                                                        </div>';
                                                } 
                                            }
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="container-crud-create">
                                <h5 class="txt_crud">Crear avión</h5>
                                <button class="btn-crud-create" type="button" onclick="window.location.href='aviones_form_create.php'">
                            ...
                            <div class="container-crud-update">
                                <h5 class="txt_crud">Modificar avión</h5>
                                <button class="btn-crud-update" type="button" onclick="window.location.href='aviones_form_update.php'">
                            ...
                            <div class="container-crud-delete">
                                <h5 class="txt_crud">Eliminar avión</h5>
                                <button class="btn-crud-delete" type="button" onclick="window.location.href='aviones_form_delete.php'">
